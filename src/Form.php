 ...
 */
namespace UserFrosting\Sprinkle\FormGeneratorJY;
    ...
    public function generate()
    {
        ...
        foreach ($this->schema->all() as $name => $input) {
            ...
            if (isset($input['form'])) {
                ...
                $type = "UserFrosting\\Sprinkle\\FormGeneratorJY\\Element\\" . Str::studly($type);

                // If class doesn't esist, default to Text element
                if (!class_exists($type)) {
                    $type = "UserFrosting\\Sprinkle\\FormGeneratorJY\\Element\\Text";
                }
