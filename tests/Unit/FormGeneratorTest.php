...
use UserFrosting\Sprinkle\FormGeneratorJY\Element\InputInterface;
 ...
 */
class FormGeneratorJYTest extends TestCase
{
    var $basePath;
    ...
    public function testTextFormElement()
    {
        ...
        $textInput = new \UserFrosting\Sprinkle\FormGeneratorJY\Element\Text("name", $inputSchema);
    ...
    public function testTextFormElementWithData()
    {
        ...
        // Get TextInput from the `name` element of the schema
        $inputSchema = $schema["name"]["form"];
        $textInput = new \UserFrosting\Sprinkle\FormGeneratorJY\Element\Text("name", $inputSchema, "The Bar project");
    ...
    public function testTextFormElementWithEmptyData()
    {
        ...
        $textInput = new \UserFrosting\Sprinkle\FormGeneratorJY\Element\Text("owner", $inputSchema, "");
